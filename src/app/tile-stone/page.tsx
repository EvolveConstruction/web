      ...
      <section className="py-16 px-4 bg-[#0a0a0a]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-[#C0C0C0] leading-relaxed mb-8">
            Our tile and stone division brings artistry and precision to every project. 
            From intricate marble mosaics to expansive natural stone installations, we work 
            with the finest materials to create stunning surfaces that stand the test of time.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="border border-[#C0C0C0]/20 p-6 bg-[#1a1a1a]">
              ...
              <p className="text-[#C0C0C0]">
                Marble, granite, porcelain, and natural stone from around the world
              </p>
            </div>
            <div className="border border-[#C0C0C0]/20 p-6 bg-[#1a1a1a]">
              <h3 className="text-xl mb-3 text-[#C0C0C0]">Precision Installation</h3>
              <p className="text-[#C0C0C0]">
                Meticulous attention to detail ensuring perfect alignment and finish
              </p>
            </div>
            <div className="border border-[#C0C0C0]/20 p-6 bg-[#1a1a1a]">
      ...
      <section className="py-16 px-4 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl md:text-5xl mb-12 text-center">
            <span className="text-[#B8935E]">Our</span> <span className="text-[#C0C0C0]">Work</span>
          </h2>
      ...
      <section className="py-16 px-4 bg-[#1a1a1a]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Kitchen Backsplashes", desc: "Custom tile and stone designs" },
              { title: "Bathroom Installations", desc: "Walls, floors, and shower enclosures" },
              { title: "Flooring", desc: "Marble, granite, and porcelain tiles" },
